...
func (c *Client) SubmitBlockAsync(block *qtumutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *qtumutil.Block, options *btcjson.SubmitBlockOptions) error {
