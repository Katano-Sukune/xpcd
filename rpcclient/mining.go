...
func (c *Client) SubmitBlockAsync(block *xpcutil.Block, options *btcjson.SubmitBlockOptions) FutureSubmitBlockResult {
	blockHex := ""
	if block != nil {
...
func (c *Client) SubmitBlock(block *xpcutil.Block, options *btcjson.SubmitBlockOptions) error {
