...
var MainNetParams = Params{
	...
	// BIP 173.
	Bech32HRPSegwit: "xpc", // always ltc for main net
...
var RegressionNetParams = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "xpcrt", // always tltc for test net

	// Address encoding magics
	PubKeyHashAddrID: 0x8a, // starts with m or n
	ScriptHashAddrID: 0x58, // starts with 2
...
var TestNet4Params = Params{
	...
	// Human-readable part for Bech32 encoded segwit addresses, as defined in
	// BIP 173.
	Bech32HRPSegwit: "txpc", // always tb for test net

	// Address encoding magics
	PubKeyHashAddrID:        0x8a, // starts with m or n
	ScriptHashAddrID:        0x58, // starts with 2
	WitnessPubKeyHashAddrID: 0xef, // starts with QW
