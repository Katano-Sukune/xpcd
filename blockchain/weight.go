...
func GetBlockWeight(blk *xpcutil.Block) int64 {
...
func GetTransactionWeight(tx *xpcutil.Tx) int64 {
	msgTx := tx.MsgTx()
...
func GetSigOpCost(tx *xpcutil.Tx, isCoinBaseTx bool, utxoView *UtxoViewpoint,
