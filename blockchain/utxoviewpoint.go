...
func (view *UtxoViewpoint) AddTxOuts(tx *xpcutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *xpcutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *xpcutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *xpcutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *xpcutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *xpcutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
