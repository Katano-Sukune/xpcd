...
func (view *UtxoViewpoint) AddTxOuts(tx *qtumutil.Tx, blockHeight int32) {
...
func (view *UtxoViewpoint) connectTransaction(tx *qtumutil.Tx, blockHeight int32, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) connectTransactions(block *qtumutil.Block, stxos *[]spentTxOut) error {
...
func (view *UtxoViewpoint) disconnectTransactions(block *qtumutil.Block, stxos []spentTxOut) error {
...
func (view *UtxoViewpoint) fetchInputUtxos(db database.DB, block *qtumutil.Block) error {
...
func (b *BlockChain) FetchUtxoView(tx *qtumutil.Tx) (*UtxoViewpoint, error) {
	b.chainLock.RLock()
