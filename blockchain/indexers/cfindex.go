...
func storeFilter(dbTx database.Tx, block *qtumutil.Block, f *gcs.Filter,
	extended bool) error {
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *qtumutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *qtumutil.Block,
	view *blockchain.UtxoViewpoint) error {
