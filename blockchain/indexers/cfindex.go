...
func storeFilter(dbTx database.Tx, block *xpcutil.Block, f *gcs.Filter,
	extended bool) error {
...
func (idx *CfIndex) ConnectBlock(dbTx database.Tx, block *xpcutil.Block,
...
func (idx *CfIndex) DisconnectBlock(dbTx database.Tx, block *xpcutil.Block,
	view *blockchain.UtxoViewpoint) error {
