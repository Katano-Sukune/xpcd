...
/*
xpcd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means xpcd will work 'out of
...
parsed when xpcd starts up.  By default, the configuration file is located at
~/.xpcd/xpcd.conf on POSIX-style operating systems and %LOCALAPPDATA%\xpcd\xpcd.conf
